...
type HealthClient interface {
	Response(ctx context.Context, in *HealthRequest, opts ...grpc_go.CallOption) (*HealthResponse, common.ErrorWithAttachment)
}
...
func (c *healthClient) Response(ctx context.Context, in *HealthRequest, opts ...grpc_go.CallOption) (*HealthResponse, common.ErrorWithAttachment) {
...
func (UnimplementedHealthServer) Response(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _Health_Response_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	...
	invo := invocation.NewRPCInvocation("Response", args, invAttachment)
	if interceptor == nil {
		result := base.XXX_GetProxyImpl().Invoke(ctx, invo)
		return result, result.Error()
	}
...
var Health_ServiceDesc = grpc_go.ServiceDesc{
	...
	Methods: []grpc_go.MethodDesc{
		{
			MethodName: "Response",
			Handler:    _Health_Response_Handler,
		},
	},
	Streams:  []grpc_go.StreamDesc{},
	Metadata: "samples_api.proto",
